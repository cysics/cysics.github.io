...
```
    ...
    ##       FREX: 이모티콘, 이야기, 그것, 재미있, 괜찮, 머리, 편하 
    ##       Lift: 강추, 과학고, 굉장하, 교대, 까맣, 도와주, 마인 
    ##       Score: 이모티콘, 재미있, 필요, 그것, 이야기, 기업, 과학 
    ## Topic 2 Top Words:
    ##       Highest Prob: 데이터, 문제, 분석, 여기, 모델, 정도, 학생 
    ##       FREX: 데이터, 예전, 고민, 예측, 테스트, 성능, 수집 
    ##       Lift: 가스, 각도, 개리, 겟다, 계측, 고정, 과일 
    ##       Score: 데이터, 분석, 모델, 문제, 테스트, 경우, 보이 
    ## Topic 3 Top Words:
    ##       Highest Prob: 박사, 저희, 해보, 말씀, 메시지, 삭제, 못하 
    ##       FREX: 박사, 저희, 메시지, 삭제, 도움, 메타, 기획 
    ##       Lift: 고기, 관계사, 그립, 김밥, 꺼지, 눈꺼풀, 래빗 
    ##       Score: 박사, 삭제, 메시지, 저희, 메타, 도움, 버스 
    ## Topic 4 Top Words:
    ##       Highest Prob: 나오, 기대, 활용, 코드, 들어오, 오픈, 기회 
    ##       FREX: 코드, 들어오, 오픈, 수업, 설계, 소스, 채팅 
    ##       Lift: 감사원, 갑작스럽, 경도, 고민중, 교수자, 구내식당, 길수 
    ##       Score: 나오, 기대, 들어오, 코드, 오픈, 수업, 채팅 
    ## Topic 5 Top Words:
    ##       Highest Prob: 코로나, 투자, 기업, 정부, 미국, 시장, 서울 
    ##       FREX: 투자, 미국, 상장, 바이러스, 경제, 금융, 세대 
    ##       Lift: 간담회, 감소, 감염, 거주, 골프, 공모, 금리 
    ##       Score: 상장, 투자, 금융, 지난해, 대우, 미래에셋, 청약 
    ## Topic 6 Top Words:
    ##       Highest Prob: 만들, 생각, 기술, 우리, 시스템, 새롭, 분야 
    ##       FREX: 생각, 검색, 대학, 이러, 잘하, 얼굴, 언어 
    ##       Lift: 감정인, 개별적, 검색엔진, 귀엽, 균형, 까라, 나나 
    ##       Score: 생각, 만들, 기술, 인식, 가치, 환경, 검색 
    ## Topic 7 Top Words:
    ##       Highest Prob: 사진, 무엇, 교수, 공부, 사업, 로봇, 딥러닝 
    ##       FREX: 사진, 코딩, 홍보, 가르치, 수학, 그러하, 공감 
    ##       Lift: 가득, 가르치, 간만, 견적, 계절, 고자, 고치 
    ##       Score: 사진, 공부, 교수, 로봇, 무엇, 코딩, 그러하 
    ## Topic 8 Top Words:
    ##       Highest Prob: 사람, 어렵, 안되, 중요, 부분, 시간, 질문 
    ##       FREX: 추천, 아이디어, 그리, 능력, 동영상, 버전, 학원 
    ##       Lift: 감각, 개척, 거구, 거로, 검지, 고수, 관련자 
    ##       Score: 사람, 어렵, 중요, 부분, 질문, 지금, 능력 
    ## Topic 9 Top Words:
    ##       Highest Prob: ai, 프렌즈, 세미나, 인공지능, 발표, 안녕, 내용 
    ##       FREX: ai, 프렌즈, 세미나, 인공지능, 소개, 영상, 러닝 
    ##       Lift: 가칭, 공동체, 레이서, 마케터, 번역기, 서정훈, 수아 
    ##       Score: ai, 프렌즈, 세미나, 인공지능, 발표, 안녕, 이번 
    ## Topic 10 Top Words:
    ##       Highest Prob: 학습, 그렇, 강화, 이해, 파이, 들어가, 프로젝트 
    ##       FREX: 학습, 그렇, 정리, 최적화, 알고리즘, 나중, 수고 
    ##       Lift: 가늘, 가요, 개념적, 개발자, 거기, 결재, 과금 
    ##       Score: 학습, 그렇, 강화, 최적화, 알고리즘, 파이, 수고 
    ## Topic 11 Top Words:
    ##       Highest Prob: 감사, 드리, 오늘, 공유, 참여, 관심, 진행 
    ##       FREX: 강의, 링크, 주제, 멋지, 축하, 연락, 대덕 
    ##       Lift: 가르침, 격하, 경품, 귀훈, 김상욱, 김승일, 김종헌 
    ##       Score: 감사, 드리, 오늘, 부탁, 참여, 링크, 유튜브 
    ## Topic 12 Top Words:
    ##       Highest Prob: 이것, 모르, 대전, 계시, 위하, 배우, 논문 
    ##       FREX: 이것, 모르, 대전, 배우, 논문, 요즘, 문화 
    ##       Lift: 간식, 고고, 교정, 그놈, 농업, 달이, 명절 
    ##       Score: 이것, 대전, 모르, 논문, 계시, 배우, 산업 
    ## Topic 13 Top Words:
    ##       Highest Prob: 가능, 대하, 사용, 연구, 보내, 이상, 과제 
    ##       FREX: 과제, 힘들, 그러, 엄청나, 기계학, 서버, 인가 
    ##       Lift: 감별, 검사자, 고찰, 금전, 독일, 마이크로, 시국 
    ##       Score: 사용, 가능, 대하, 연구, 과제, 이상, 생기
